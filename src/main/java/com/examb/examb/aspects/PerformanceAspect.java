package com.examb.examb.aspects;
...
public class PerformanceAspect {
    ...
    //@Around("execution(* com.examb.examb.Services.ServiceImp.add(..))")
...
//		obj = (List<Object>) pjp.proceed();
    ...
    //
    //@Around("execution(* com.examb.examb.Services.ServiceImp.retrieveAll(..))")
